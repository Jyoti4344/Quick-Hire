...
function Interview() {
  ...
  const toggleCamera = async () => {
    try {
      ...
      setError("Could not access the camera. Check permissions or device availability.");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const openFeedbackForm = () => {
    const googleFormUrl = 'https://docs.google.com/forms/d/e/1FAIpQLSf1oqvWLnLy8NbJNnDggIbafCYlw1KUuNoxM6sPVjbGia5W_A/viewform?usp=sf_link';
    window.open(googleFormUrl, '_blank');
    setIsMenuOpen(false);  // Close the menu after opening the form
  };
